...
class AuthSystem {
    ...
    initForms() {
        var _a, _b;
        (_a = document.getElementById('toggleForm')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (e) => {
            e.preventDefault();
            this.currentForm = this.currentForm === 'login' ? 'register' : 'login';
            this.renderForm();
        });
        (_b = document.getElementById('authForm')) === null || _b === void 0 ? void 0 : _b.addEventListener('submit', (e) => {
            e.preventDefault();
            this.handleSubmit();
        });
    }
